...
const existingUser = LoginData.validCredentials.username     //aca creamos una variable para que realice la segunda prueba el usuario deberia ser invalido porque ya es existente
...
describe(CommonPageData.testSuites.resgistro,()=>{//aca llamamos a la variable que ya declaramos en commonpage
    ...
    it("Registro de usuario invalido",()=>{
            ...
            Logger.stepNumber(3)//paso3
            Logger.step('completar algunos campos con informacion invalida')//descripcion
            ...
            Logger.stepNumber(4)//paso 4
            Logger.step('hacer click en "Sing up "para registrar el usuario')//hacer click en boton signup
            SignupMethods.clickOnSignupButton();//metodo que hace click en el boton
            Logger.verification('verificar que se muestre un error indicando los campos invalidos')
